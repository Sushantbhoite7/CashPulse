  ...
  return (
    <header className="sticky top-0 z-30 border-b border-border bg-background/70 backdrop-blur-xl">
      <div className="flex items-center gap-3 px-4 md:px-6 h-14">
        <div className="flex items-center gap-1 rounded-full bg-surface/70 border border-border p-1">
          {personas.map((p) => {
        ...
        <div className="ml-auto flex items-center gap-2">
          <div className="relative">
            <select
              ...
              className="appearance-none rounded-lg bg-surface/70 border border-border pl-3 pr-8 py-1.5 text-xs font-medium hover:bg-surface-2/70"
            >
